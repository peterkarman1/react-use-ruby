...
const useRubyPlugin = {
  ...
  setup(build) {
    build.onLoad({ filter: /.js$/ }, (args) => ({
      contents: transformToUseRuby(args),
      loader: "js",
    }));
